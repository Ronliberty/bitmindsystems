...
export default function VideoEditingDashboard() {
  ...
  const quickActions = [
    { title: "New Project", icon: <Film className="w-6 h-6" />, href: "/video/new" },
    { title: "Upload Footage", icon: <Upload className="w-6 h-6" />, href: "/video/upload" },
    { title: "Team Management", icon: <Users className="w-6 h-6" />, href: "/video/team" },
    { title: "Render Settings", icon: <Settings className="w-6 h-6" />, href: "/video/render" },
  ];
