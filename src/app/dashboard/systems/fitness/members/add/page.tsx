...
import { Calendar, PlusCircle, Edit2, Trash2, X, ChevronDown } from "lucide-react";
...
export default function EventsPage() {
  const [events, setEvents] = useState<EventData[]>([
    {
      ...
      type: "Outdoor",
      description: "A fun and intensive fitness session with certified trainers.",
    },
    {
      id: 2,
      ...
      type: "Indoor",
      description: "Learn about meal planning, hydration, and recovery strategies.",
    },
  ]);
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    setFormData({ name: "", date: "", location: "", type: "", description: "" });
  ...
  {isDropdownOpen && (
    <motion.div
      ...
      className="absolute w-full mt-2 rounded-xl border border-border bg-gradient-to-br from-muted/90 to-background shadow-xl backdrop-blur-sm overflow-hidden z-50"
    >
      {eventTypes.map((type) => (
        <button
          key={type}
